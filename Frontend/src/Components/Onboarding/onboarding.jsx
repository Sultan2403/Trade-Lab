...
export default function Onboarding() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl rounded-panel border border-border bg-surface-card p-8 shadow-sm">
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl font-semibold">
          {hasAccounts ? "Select a Trading Account" : "Welcome to TradeLog"}
        </h1>
            ...
            {accounts.map((account) => {
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-panel border p-5 text-left transition-colors ${
                    isSelected
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    {account.type && (
                      <span className="rounded-md bg-surface-muted px-3 py-1 text-caption text-text-secondary">
                        {account.type}
                      </span>
                    )}
                  </div>
      ...
      <div className="mt-10 flex flex-col items-center text-center text-text-muted">
        ...
        <p className="text-body">
          {hasAccounts ? "Your trading dashboard awaits" : "Your trading journey starts here"}
        </p>
      </div>
    </div>
  );
